...
for i=1:numel(non_standard_param(1))

non_standard_param(i).RMSE_ENSO_3D=1-non_standard_param(i).RMSE_ENSO_3D./stdev;
non_standard_param(i).RelEntropy_ENSO_3D=1-exp(-non_standard_param(i).RelEntropy_ENSO_3D);

end


truth=[non_standard_param(1).response_test_1;non_standard_param(1).response_test_2];
...
for i=1:numel(non_standard_param)
    
TE_prior=[non_standard_param(i).TE_prediction_Linearnet_prior_1;non_standard_param(i).TE_prediction_Linearnet_prior_2];
TE_priordata=[non_standard_param(i).TE_prediction_Linearnet_priordata_1;non_standard_param(i).TE_prediction_Linearnet_priordata_2];
TE_priorpost=[non_standard_param(i).TE_prediction_Linearnet_priorpost_1;non_standard_param(i).TE_prediction_Linearnet_priorpost_2];
TE_priorpostdata=[non_standard_param(i).TE_prediction_Linearnet_priorpostdata_1;non_standard_param(i).TE_prediction_Linearnet_priorpostdata_2];
TE_data=[non_standard_param(i).TE_prediction_Linearnet_data_1;non_standard_param(i).TE_prediction_Linearnet_data_2];
TE_sampling=[non_standard_param(i).TE_prediction_Linearnet_sampling_1;non_standard_param(i).TE_prediction_Linearnet_sampling_2];

TE_priorval=[non_standard_param(i).TE_prediction_Linearnet_priorval_1;non_standard_param(i).TE_prediction_Linearnet_priorval_2];
TE_priordataval=[non_standard_param(i).TE_prediction_Linearnet_priordataval_1;non_standard_param(i).TE_prediction_Linearnet_priordataval_2];
TE_priorpostval=[non_standard_param(i).TE_prediction_Linearnet_priorpostval_1;non_standard_param(i).TE_prediction_Linearnet_priorpostval_2];
TE_priorpostdataval=[non_standard_param(i).TE_prediction_Linearnet_priorpostdataval_1;non_standard_param(i).TE_prediction_Linearnet_priorpostdataval_2];
TE_dataval=[non_standard_param(i).TE_prediction_Linearnet_dataval_1;non_standard_param(i).TE_prediction_Linearnet_dataval_2];
TE_samplingval=[non_standard_param(i).TE_prediction_Linearnet_samplingval_1;non_standard_param(i).TE_prediction_Linearnet_samplingval_2];

TE_priorns=[non_standard_param(i).TE_prediction_Linearnet_priorns_1;non_standard_param(i).TE_prediction_Linearnet_priorns_2];
TE_priordatans=[non_standard_param(i).TE_prediction_Linearnet_priordatans_1;non_standard_param(i).TE_prediction_Linearnet_priordatans_2];
TE_priorpostns=[non_standard_param(i).TE_prediction_Linearnet_priorpostns_1;non_standard_param(i).TE_prediction_Linearnet_priorpostns_2];
TE_priorpostdatans=[non_standard_param(i).TE_prediction_Linearnet_priorpostdatans_1;non_standard_param(i).TE_prediction_Linearnet_priorpostdatans_2];
TE_datans=[non_standard_param(i).TE_prediction_Linearnet_datans_1;non_standard_param(i).TE_prediction_Linearnet_datans_2];
TE_samplingns=[non_standard_param(i).TE_prediction_Linearnet_samplingns_1;non_standard_param(i).TE_prediction_Linearnet_samplingns_2];
...
TEHW_prior=[non_standard_param(i).TEHW_prediction_Linearnet_prior_1;non_standard_param(i).TEHW_prediction_Linearnet_prior_2];
TEHW_priordata=[non_standard_param(i).TEHW_prediction_Linearnet_priordata_1;non_standard_param(i).TEHW_prediction_Linearnet_priordata_2];
TEHW_priorpost=[non_standard_param(i).TEHW_prediction_Linearnet_priorpost_1;non_standard_param(i).TEHW_prediction_Linearnet_priorpost_2];
TEHW_priorpostdata=[non_standard_param(i).TEHW_prediction_Linearnet_priorpostdata_1;non_standard_param(i).TEHW_prediction_Linearnet_priorpostdata_2];
TEHW_data=[non_standard_param(i).TEHW_prediction_Linearnet_data_1;non_standard_param(i).TEHW_prediction_Linearnet_data_2];
TEHW_sampling=[non_standard_param(i).TEHW_prediction_Linearnet_sampling_1;non_standard_param(i).TEHW_prediction_Linearnet_sampling_2];

TEHW_priorval=[non_standard_param(i).TEHW_prediction_Linearnet_priorval_1;non_standard_param(i).TEHW_prediction_Linearnet_priorval_2];
TEHW_priordataval=[non_standard_param(i).TEHW_prediction_Linearnet_priordataval_1;non_standard_param(i).TEHW_prediction_Linearnet_priordataval_2];
TEHW_priorpostval=[non_standard_param(i).TEHW_prediction_Linearnet_priorpostval_1;non_standard_param(i).TEHW_prediction_Linearnet_priorpostval_2];
TEHW_priorpostdataval=[non_standard_param(i).TEHW_prediction_Linearnet_priorpostdataval_1;non_standard_param(i).TEHW_prediction_Linearnet_priorpostdataval_2];
TEHW_dataval=[non_standard_param(i).TEHW_prediction_Linearnet_dataval_1;non_standard_param(i).TEHW_prediction_Linearnet_dataval_2];
TEHW_samplingval=[non_standard_param(i).TEHW_prediction_Linearnet_samplingval_1;non_standard_param(i).TEHW_prediction_Linearnet_samplingval_2];

TEHW_priorns=[non_standard_param(i).TEHW_prediction_Linearnet_priorns_1;non_standard_param(i).TEHW_prediction_Linearnet_priorns_2];
TEHW_priordatans=[non_standard_param(i).TEHW_prediction_Linearnet_priordatans_1;non_standard_param(i).TEHW_prediction_Linearnet_priordatans_2];
TEHW_priorpostns=[non_standard_param(i).TEHW_prediction_Linearnet_priorpostns_1;non_standard_param(i).TEHW_prediction_Linearnet_priorpostns_2];
TEHW_priorpostdatans=[non_standard_param(i).TEHW_prediction_Linearnet_priorpostdatans_1;non_standard_param(i).TEHW_prediction_Linearnet_priorpostdatans_2];
TEHW_datans=[non_standard_param(i).TEHW_prediction_Linearnet_datans_1;non_standard_param(i).TEHW_prediction_Linearnet_datans_2];
TEHW_samplingns=[non_standard_param(i).TEHW_prediction_Linearnet_samplingns_1;non_standard_param(i).TEHW_prediction_Linearnet_samplingns_2];
...
TEWB_prior=[non_standard_param(i).TEWB_prediction_Linearnet_prior_1;non_standard_param(i).TEWB_prediction_Linearnet_prior_2];
TEWB_priordata=[non_standard_param(i).TEWB_prediction_Linearnet_priordata_1;non_standard_param(i).TEWB_prediction_Linearnet_priordata_2];
TEWB_priorpost=[non_standard_param(i).TEWB_prediction_Linearnet_priorpost_1;non_standard_param(i).TEWB_prediction_Linearnet_priorpost_2];
TEWB_priorpostdata=[non_standard_param(i).TEWB_prediction_Linearnet_priorpostdata_1;non_standard_param(i).TEWB_prediction_Linearnet_priorpostdata_2];
TEWB_data=[non_standard_param(i).TEWB_prediction_Linearnet_data_1;non_standard_param(i).TEWB_prediction_Linearnet_data_2];
TEWB_sampling=[non_standard_param(i).TEWB_prediction_Linearnet_sampling_1;non_standard_param(i).TEWB_prediction_Linearnet_sampling_2];

TEWB_priorval=[non_standard_param(i).TEWB_prediction_Linearnet_priorval_1;non_standard_param(i).TEWB_prediction_Linearnet_priorval_2];
TEWB_priordataval=[non_standard_param(i).TEWB_prediction_Linearnet_priordataval_1;non_standard_param(i).TEWB_prediction_Linearnet_priordataval_2];
TEWB_priorpostval=[non_standard_param(i).TEWB_prediction_Linearnet_priorpostval_1;non_standard_param(i).TEWB_prediction_Linearnet_priorpostval_2];
TEWB_priorpostdataval=[non_standard_param(i).TEWB_prediction_Linearnet_priorpostdataval_1;non_standard_param(i).TEWB_prediction_Linearnet_priorpostdataval_2];
TEWB_dataval=[non_standard_param(i).TEWB_prediction_Linearnet_dataval_1;non_standard_param(i).TEWB_prediction_Linearnet_dataval_2];
TEWB_samplingval=[non_standard_param(i).TEWB_prediction_Linearnet_samplingval_1;non_standard_param(i).TEWB_prediction_Linearnet_samplingval_2];

TEWB_priorns=[non_standard_param(i).TEWB_prediction_Linearnet_priorns_1;non_standard_param(i).TEWB_prediction_Linearnet_priorns_2];
TEWB_priordatans=[non_standard_param(i).TEWB_prediction_Linearnet_priordatans_1;non_standard_param(i).TEWB_prediction_Linearnet_priordatans_2];
TEWB_priorpostns=[non_standard_param(i).TEWB_prediction_Linearnet_priorpostns_1;non_standard_param(i).TEWB_prediction_Linearnet_priorpostns_2];
TEWB_priorpostdatans=[non_standard_param(i).TEWB_prediction_Linearnet_priorpostdatans_1;non_standard_param(i).TEWB_prediction_Linearnet_priorpostdatans_2];
TEWB_datans=[non_standard_param(i).TEWB_prediction_Linearnet_datans_1;non_standard_param(i).TEWB_prediction_Linearnet_datans_2];
TEWB_samplingns=[non_standard_param(i).TEWB_prediction_Linearnet_samplingns_1;non_standard_param(i).TEWB_prediction_Linearnet_samplingns_2];
...
TEWBHW_prior=[non_standard_param(i).TEWBHW_prediction_Linearnet_prior_1;non_standard_param(i).TEWBHW_prediction_Linearnet_prior_2];
TEWBHW_priordata=[non_standard_param(i).TEWBHW_prediction_Linearnet_priordata_1;non_standard_param(i).TEWBHW_prediction_Linearnet_priordata_2];
TEWBHW_priorpost=[non_standard_param(i).TEWBHW_prediction_Linearnet_priorpost_1;non_standard_param(i).TEWBHW_prediction_Linearnet_priorpost_2];
TEWBHW_priorpostdata=[non_standard_param(i).TEWBHW_prediction_Linearnet_priorpostdata_1;non_standard_param(i).TEWBHW_prediction_Linearnet_priorpostdata_2];
TEWBHW_data=[non_standard_param(i).TEWBHW_prediction_Linearnet_data_1;non_standard_param(i).TEWBHW_prediction_Linearnet_data_2];
TEWBHW_sampling=[non_standard_param(i).TEWBHW_prediction_Linearnet_sampling_1;non_standard_param(i).TEWBHW_prediction_Linearnet_sampling_2];

TEWBHW_priorval=[non_standard_param(i).TEWBHW_prediction_Linearnet_priorval_1;non_standard_param(i).TEWBHW_prediction_Linearnet_priorval_2];
TEWBHW_priordataval=[non_standard_param(i).TEWBHW_prediction_Linearnet_priordataval_1;non_standard_param(i).TEWBHW_prediction_Linearnet_priordataval_2];
TEWBHW_priorpostval=[non_standard_param(i).TEWBHW_prediction_Linearnet_priorpostval_1;non_standard_param(i).TEWBHW_prediction_Linearnet_priorpostval_2];
TEWBHW_priorpostdataval=[non_standard_param(i).TEWBHW_prediction_Linearnet_priorpostdataval_1;non_standard_param(i).TEWBHW_prediction_Linearnet_priorpostdataval_2];
TEWBHW_dataval=[non_standard_param(i).TEWBHW_prediction_Linearnet_dataval_1;non_standard_param(i).TEWBHW_prediction_Linearnet_dataval_2];
TEWBHW_samplingval=[non_standard_param(i).TEWBHW_prediction_Linearnet_samplingval_1;non_standard_param(i).TEWBHW_prediction_Linearnet_samplingval_2];

TEWBHW_priorns=[non_standard_param(i).TEWBHW_prediction_Linearnet_priorns_1;non_standard_param(i).TEWBHW_prediction_Linearnet_priorns_2];
TEWBHW_priordatans=[non_standard_param(i).TEWBHW_prediction_Linearnet_priordatans_1;non_standard_param(i).TEWBHW_prediction_Linearnet_priordatans_2];
TEWBHW_priorpostns=[non_standard_param(i).TEWBHW_prediction_Linearnet_priorpostns_1;non_standard_param(i).TEWBHW_prediction_Linearnet_priorpostns_2];
TEWBHW_priorpostdatans=[non_standard_param(i).TEWBHW_prediction_Linearnet_priorpostdatans_1;non_standard_param(i).TEWBHW_prediction_Linearnet_priorpostdatans_2];
TEWBHW_datans=[non_standard_param(i).TEWBHW_prediction_Linearnet_datans_1;non_standard_param(i).TEWBHW_prediction_Linearnet_datans_2];
TEWBHW_samplingns=[non_standard_param(i).TEWBHW_prediction_Linearnet_samplingns_1;non_standard_param(i).TEWBHW_prediction_Linearnet_samplingns_2];
...
% pc5_TE_pc_Linearnet_prior = zeros(numel(non_standard_param),1);
% pc5_TE_pc_Linearnet_priordata = zeros(numel(non_standard_param),1);
% pc5_TE_pc_Linearnet_priorpost = zeros(numel(non_standard_param),1);
% pc5_TE_pc_Linearnet_priorpostdata = zeros(numel(non_standard_param),1);
% pc5_TE_pc_Linearnet_data = zeros(numel(non_standard_param),1);
% pc5_TE_pc_Linearnet_sampling = zeros(numel(non_standard_param),1);
% 
% pc5_TE_pc_Linearnet_priorval = zeros(numel(non_standard_param),1);
% pc5_TE_pc_Linearnet_priordataval = zeros(numel(non_standard_param),1);
% pc5_TE_pc_Linearnet_priorpostval = zeros(numel(non_standard_param),1);
% pc5_TE_pc_Linearnet_priorpostdataval = zeros(numel(non_standard_param),1);
% pc5_TE_pc_Linearnet_dataval = zeros(numel(non_standard_param),1);
% pc5_TE_pc_Linearnet_samplingval = zeros(numel(non_standard_param),1);
% 
% 
% pc5_TE_pc_Linearnet_priorns = zeros(numel(non_standard_param),1);
% pc5_TE_pc_Linearnet_priordatans = zeros(numel(non_standard_param),1);
% pc5_TE_pc_Linearnet_priorpostns = zeros(numel(non_standard_param),1);
% pc5_TE_pc_Linearnet_priorpostdatans = zeros(numel(non_standard_param),1);
% pc5_TE_pc_Linearnet_datans = zeros(numel(non_standard_param),1);
% pc5_TE_pc_Linearnet_samplingns = zeros(numel(non_standard_param),1);
% 
% 
% pc5_TEHW_pc_Linearnet_prior = zeros(numel(non_standard_param),1);
% pc5_TEHW_pc_Linearnet_priordata = zeros(numel(non_standard_param),1);
% pc5_TEHW_pc_Linearnet_priorpost = zeros(numel(non_standard_param),1);
% pc5_TEHW_pc_Linearnet_priorpostdata = zeros(numel(non_standard_param),1);
% pc5_TEHW_pc_Linearnet_data = zeros(numel(non_standard_param),1);
% pc5_TEHW_pc_Linearnet_sampling = zeros(numel(non_standard_param),1);
% 
% pc5_TEHW_pc_Linearnet_priorval = zeros(numel(non_standard_param),1);
% pc5_TEHW_pc_Linearnet_priordataval = zeros(numel(non_standard_param),1);
% pc5_TEHW_pc_Linearnet_priorpostval = zeros(numel(non_standard_param),1);
% pc5_TEHW_pc_Linearnet_priorpostdataval = zeros(numel(non_standard_param),1);
% pc5_TEHW_pc_Linearnet_dataval = zeros(numel(non_standard_param),1);
% pc5_TEHW_pc_Linearnet_samplingval = zeros(numel(non_standard_param),1);
% 

% pc5_TEHW_pc_Linearnet_priorns = zeros(numel(non_standard_param),1);
% pc5_TEHW_pc_Linearnet_priordatans = zeros(numel(non_standard_param),1);
% pc5_TEHW_pc_Linearnet_priorpostns = zeros(numel(non_standard_param),1);
% pc5_TEHW_pc_Linearnet_priorpostdatans = zeros(numel(non_standard_param),1);
% pc5_TEHW_pc_Linearnet_datans = zeros(numel(non_standard_param),1);
% pc5_TEHW_pc_Linearnet_samplingns = zeros(numel(non_standard_param),1);
% 
% 
% pc5_TEWB_pc_Linearnet_prior = zeros(numel(non_standard_param),1);
% pc5_TEWB_pc_Linearnet_priordata = zeros(numel(non_standard_param),1);
% pc5_TEWB_pc_Linearnet_priorpost = zeros(numel(non_standard_param),1);
% pc5_TEWB_pc_Linearnet_priorpostdata = zeros(numel(non_standard_param),1);
% pc5_TEWB_pc_Linearnet_data = zeros(numel(non_standard_param),1);
% pc5_TEWB_pc_Linearnet_sampling = zeros(numel(non_standard_param),1);
% 
% pc5_TEWB_pc_Linearnet_priorval = zeros(numel(non_standard_param),1);
% pc5_TEWB_pc_Linearnet_priordataval = zeros(numel(non_standard_param),1);
% pc5_TEWB_pc_Linearnet_priorpostval = zeros(numel(non_standard_param),1);
% pc5_TEWB_pc_Linearnet_priorpostdataval = zeros(numel(non_standard_param),1);
% pc5_TEWB_pc_Linearnet_dataval = zeros(numel(non_standard_param),1);
% pc5_TEWB_pc_Linearnet_samplingval = zeros(numel(non_standard_param),1);
% 
% 
% pc5_TEWB_pc_Linearnet_priorns = zeros(numel(non_standard_param),1);
% pc5_TEWB_pc_Linearnet_priordatans = zeros(numel(non_standard_param),1);
% pc5_TEWB_pc_Linearnet_priorpostns = zeros(numel(non_standard_param),1);
% pc5_TEWB_pc_Linearnet_priorpostdatans = zeros(numel(non_standard_param),1);
% pc5_TEWB_pc_Linearnet_datans = zeros(numel(non_standard_param),1);
% pc5_TEWB_pc_Linearnet_samplingns = zeros(numel(non_standard_param),1);
% 

pc5_TEWBHW_pc_Linearnet_prior = zeros(numel(non_standard_param),1);
pc5_TEWBHW_pc_Linearnet_priordata = zeros(numel(non_standard_param),1);
pc5_TEWBHW_pc_Linearnet_priorpost = zeros(numel(non_standard_param),1);
pc5_TEWBHW_pc_Linearnet_priorpostdata = zeros(numel(non_standard_param),1);
pc5_TEWBHW_pc_Linearnet_data = zeros(numel(non_standard_param),1);
pc5_TEWBHW_pc_Linearnet_sampling = zeros(numel(non_standard_param),1);

pc5_TEWBHW_pc_Linearnet_priorval = zeros(numel(non_standard_param),1);
pc5_TEWBHW_pc_Linearnet_priordataval = zeros(numel(non_standard_param),1);
pc5_TEWBHW_pc_Linearnet_priorpostval = zeros(numel(non_standard_param),1);
pc5_TEWBHW_pc_Linearnet_priorpostdataval = zeros(numel(non_standard_param),1);
pc5_TEWBHW_pc_Linearnet_dataval = zeros(numel(non_standard_param),1);
pc5_TEWBHW_pc_Linearnet_samplingval = zeros(numel(non_standard_param),1);


pc5_TEWBHW_pc_Linearnet_priorns = zeros(numel(non_standard_param),1);
pc5_TEWBHW_pc_Linearnet_priordatans = zeros(numel(non_standard_param),1);
pc5_TEWBHW_pc_Linearnet_priorpostns = zeros(numel(non_standard_param),1);
pc5_TEWBHW_pc_Linearnet_priorpostdatans = zeros(numel(non_standard_param),1);
pc5_TEWBHW_pc_Linearnet_datans = zeros(numel(non_standard_param),1);
pc5_TEWBHW_pc_Linearnet_samplingns = zeros(numel(non_standard_param),1);
