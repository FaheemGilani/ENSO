function generate_covariate_data(d_u,d_tau,omega_u,sigma_u,alpha_1,alpha_2,sigma_tau_scale)
...
no_tr=30;
specs=1;
Gen_1=samplejoin(time_1,no_tr,d_u,d_tau,omega_u,sigma_u,alpha_1,alpha_2,sigma_tau_scale);
Gen_2=samplejoin(time_2,no_tr,d_u,d_tau,omega_u,sigma_u,alpha_1,alpha_2,sigma_tau_scale);
...
% cd('/ENSO/codes/Meetings/Feb_5_2021/')
...
[covariate_priordata_1,response_priordata_1,~]=embed_multi(priordata_training_1,max_time,lag,exp_index,numavg,resp_index);
[covariate_priordata_2,response_priordata_2,~]=embed_multi(priordata_training_2,max_time,lag,exp_index,numavg,resp_index);


[covariate_priorpost_1,response_priorpost_1,~]=embed_multi(priorpost_training_1,max_time,lag,exp_index,numavg,resp_index);
[covariate_priorpost_2,response_priorpost_2,~]=embed_multi(priorpost_training_2,max_time,lag,exp_index,numavg,resp_index);

[covariate_priorpostdata_1,response_priorpostdata_1,~]=embed_multi(priorpostdata_training_1,max_time,lag,exp_index,numavg,resp_index);
[covariate_priorpostdata_2,response_priorpostdata_2,~]=embed_multi(priorpostdata_training_2,max_time,lag,exp_index,numavg,resp_index);


[covariate_prior_1,response_prior_1,~]=embed_multi(prior_training_1,max_time,lag,exp_index,numavg,resp_index);
[covariate_prior_2,response_prior_2,~]=embed_multi(prior_training_2,max_time,lag,exp_index,numavg,resp_index,0);

[covariate_test_1,response_test_1,time_1]=embed_multi(testing_struct_1,max_time,lag,exp_index,numavg,resp_index);
[covariate_test_2,response_test_2,time_2]=embed_multi(testing_struct_2,max_time,lag,exp_index,numavg,resp_index);


[covariate_sampling_1,response_sampling_1,~]=embed_multi(sampling_training_struct_1,max_time,lag,exp_index,numavg,resp_index);
[covariate_sampling_2,response_sampling_2,~]=embed_multi(sampling_training_struct_2,max_time,lag,exp_index,numavg,resp_index);
...
[Dcovariate_train_1,Dresponse_train_1,~]=embed_multi(data_training_struct_1,max_time,lag,exp_index,numavg,resp_index);
[Dcovariate_train_2,Dresponse_train_2,~]=embed_multi(data_training_struct_2,max_time,lag,exp_index,numavg,resp_index);


disp('done')


save('data_for_net.mat','covariate_priordata_1','covariate_priorpost_1','covariate_priorpostdata_1','covariate_priordata_2','covariate_priorpost_2','covariate_priorpostdata_2',...
    ...
    'Dresponse_train_2','time_1','time_2')
